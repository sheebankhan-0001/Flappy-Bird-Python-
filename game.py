...
class Game:
    def __init__(self):
        ...
        self.restart_text = self.font.render("Game Over! Press Restart", True, (0, 0, 0))
        self.restart_text_rect = self.restart_text.get_rect(center=(self.width // 2, self.height // 2))
